...
<html lang="en">
  <head>
    ...
    <title>Post Standard Image Fullwidth</title>
      ...
      <div class="post">
        <div class="post-standard -full">
          <div class="post-standard__banner">
            <div class="post-standard__banner__image"><img src="assets/images/post_detail/standard/banner-full.png" alt="Post banner image"/></div>
