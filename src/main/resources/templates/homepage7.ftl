...
<html lang="en">
  ...
  <body>
    ...
    <div class="no-pd" id="content">
      <div class="blog-ocean">
        <div class="container-max no-gutter">
          <div class="blog-ocean__slider">
            <div class="blog-ocean__slider__item">
              <div class="slider-item__image"><img src="assets/images/backgrounds/slider-bg-1.png" alt="1"/></div>
            ...
            <div class="blog-ocean__slider__item">
              <div class="slider-item__image"><img src="assets/images/backgrounds/slider-bg-2.png" alt="1"/></div>
              <div class="slider-item__content">
                    <div class="post-card -center -theme--blue">
                      <div></div>
                      <div class="card__content">
          ...
          <div class="blog-ocean__content">
            <div class="news-block -theme--blue">
                  <div class="news-block__header">
                    ...
                    <div class="header__controller">
                      <div class="header__controller__tab"><a class="active tab-item" href="#" title="all" data-for="all">all</a><a class="tab-item" href="#" title="american" data-for="american">american</a><a class="tab-item" href="#" title="asian" data-for="asian">asian</a><a class="tab-item" href="#" title="africa" data-for="africa">africa</a>
                      </div>
              ...
              <div class="news-block__tab">
                ...
                <div class="news-block__tab__item" data-tab-name="american">
                  <div class="news-block__content -default">
                    <div class="news-block__content__slide">
                      <div class="row">
                        <div class="col-12 col-lg-6">
                ...
                <div class="news-block__tab__item" data-tab-name="asian">
                  <div class="news-block__content -default">
                    <div class="news-block__content__slide">
                      <div class="row">
                        <div class="col-12 col-lg-6">
                ...
                <div class="news-block__tab__item" data-tab-name="africa">
                  <div class="news-block__content -default">
                    <div class="news-block__content__slide">
                      <div class="row">
                        <div class="col-12 col-lg-6">
              ...
              <div class="row no-gutters">
                <div class="col-12 col-md-8">
                  <div class="video-view">
                    <h2 id="video-list__title">Looking for Music & Sounds for my new Android</h2>
                ...
                <div class="col-12 col-md-4">
                  <div class="video-list">
                    ...
                    <div class="video-list__content"><a class="video-list__content__item active" href="#" data-src="25323516">
                        <div class="item__image"><img src="assets/images/posts/sea/video/1.png" alt="Looking for Music &amp; Sounds for my new Android"/></div>
                        <div class="item__detail">
                          <h5>Looking for Music &amp; Sounds for my new Android</h5>
                          <p>3:15</p>
                        </div></a><a class="video-list__content__item" href="#" data-src="113893889">
                        <div class="item__image"><img src="assets/images/posts/sea/video/2.png" alt="10 Best Travel Yoga Mats On Amazon, Based On..."/></div>
                        <div class="item__detail">
                          <h5>10 Best Travel Yoga Mats On Amazon, Based On...</h5>
                          <p>2:04</p>
                        </div></a><a class="video-list__content__item" href="#" data-src="39050404">
                        <div class="item__image"><img src="assets/images/posts/sea/video/3.png" alt="Looking for Music &amp; Sounds for my new Android"/></div>
                        <div class="item__detail">
                          <h5>Looking for Music &amp; Sounds for my new Android</h5>
                          <p>1:85</p>
                        </div></a><a class="video-list__content__item" href="#" data-src="140985904">
                        <div class="item__image"><img src="assets/images/posts/sea/video/4.png" alt="The Truth About Ocean Is About To Be Revealed."/></div>
                        <div class="item__detail">
                          <h5>The Truth About Ocean Is About To Be Revealed.</h5>
                          <p>7:00</p>
                        </div></a>
                    </div>
                  </div>
            ...
            <div class="news-block -theme--blue">
                  <div class="news-block__header">
                    ...
                    <div class="header__controller">
                      <div class="header__controller__tab"><a class="active tab-item" href="#" title="all" data-for="all">all</a><a class="tab-item" href="#" title="flight" data-for="flight">flight</a><a class="tab-item" href="#" title="hotel &amp; resort" data-for="hotel &amp; resort">hotel &amp; resort</a><a class="tab-item" href="#" title="food" data-for="food">food</a><a class="tab-item" href="#" title="cultural" data-for="cultural">cultural</a>
                      </div>
                      <div class="header__controller__slider-control"></div>
                    </div>
                  </div>
              <div class="news-block__tab">
                ...
                <div class="news-block__tab__item" data-tab-name="flight">
                  <div class="news-block__content -hoz">
                    <div class="news-block__content__slide">
                      <div class="row">
                        <div class="col-12">
                ...
                <div class="news-block__tab__item" data-tab-name="hotel &amp; resort">
                  <div class="news-block__content -hoz">
                    <div class="news-block__content__slide">
                      <div class="row">
                        <div class="col-12">
                ...
                <div class="news-block__tab__item" data-tab-name="food">
                  <div class="news-block__content -hoz">
                    <div class="news-block__content__slide">
                      <div class="row">
                        <div class="col-12">
                ...
                <div class="news-block__tab__item" data-tab-name="cultural">
                  <div class="news-block__content -hoz">
                    <div class="news-block__content__slide">
                      <div class="row">
                        <div class="col-12">
            ...
            <div class="news-block -theme--blue">
                  <div class="news-block__header">
                    ...
                    <div class="header__controller">
                      <div class="header__controller__tab"><a class="active tab-item" href="#" title="all" data-for="all">all</a><a class="tab-item" href="#" title="destination" data-for="destination">destination</a><a class="tab-item" href="#" title="guides" data-for="guides">guides</a><a class="tab-item" href="#" title="stories" data-for="stories">stories</a>
                      </div>
                      <div class="header__controller__slider-control"></div>
                    </div>
                  </div>
              <div class="news-block__tab">
                ...
                <div class="news-block__tab__item" data-tab-name="destination">
                  <div class="news-block__content -hoz-small">
                    <div class="news-block__content__slide">
                      <div class="row">
                        <div class="col-12 col-md-6">
                ...
                <div class="news-block__tab__item" data-tab-name="guides">
                  <div class="news-block__content -hoz-small">
                    <div class="news-block__content__slide">
                      <div class="row">
                        <div class="col-12 col-md-6">
                ...
                <div class="news-block__tab__item" data-tab-name="stories">
                  <div class="news-block__content -hoz-small">
                    <div class="news-block__content__slide">
                      <div class="row">
                        <div class="col-12 col-md-6">
        ...
        <div class="instagrams -theme--blue">
