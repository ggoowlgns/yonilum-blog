      ...
      <div class="container">
        ...
        <div class="cart">
          ...
          <div class="cart__footer">
            <div class="cart__footer__actions"><a class="btn -light-overlay" href="shop.ftl">CONTINUE SHOPPING</a><a class="btn -light-overlay" href="shop.ftl">Upadte cart</a></div>
          </div>
              ...
              <div class="col-12 col-md-4">
                <div class="cart__total__content">
                  ...
                  <div class="total__row">
                    <h5>Subtotal</h5>
                    <h5>$ 152.0</h5>
                  </div><a class="btn" href="checkout.ftl">PPROCEED TO CHECKOUT</a>
                </div>
              </div>
            </div>
          </div>
