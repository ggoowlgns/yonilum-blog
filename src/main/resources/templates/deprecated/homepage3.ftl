...
<html lang="en">
  ...
  <body>
    ...
    <div id="content">
      <div class="container">
        <div class="blog-masonry-sidebar">
          <div class="row">
            ...
            <div class="col-12 col-md-7 col-lg-8 order-md-1">
              <div class="blog-masonry blog-masonry-sidebar__content">
                    <div class="post-card -center"><a class="card__cover" href="../post_standard.ftl"><img src="assets/images/posts/1.png" alt="Looking for some feedback for this rejected track"/></a>
                    ...
                    <div class="post-card -center"><a class="card__cover" href="../post_standard.ftl"><img src="assets/images/posts/2.png" alt="How to name, save and export a finish template"/></a>
                      <div class="card__content">
                    ...
                    <div class="post-card -center"><a class="card__cover" href="../post_standard.ftl"><img src="assets/images/posts/3.png" alt="I want to create a logo with illustrator hacker"/></a>
                      <div class="card__content">
                    ...
                    <div class="post-card -center"><a class="card__cover" href="../post_standard.ftl"><img src="assets/images/posts/4.png" alt="where I can found the sound in this video template?"/></a>
                      <div class="card__content">
                    ...
                    <div class="post-card -video -center">
                    ...
                    <div class="post-card -center">
                      <div class="card__cover -slide">
                        <div class="card__cover__slide-item"><img src="assets/images/posts/2.png" alt="Looking for some feedback for this rejected track"/></div>
                        <div class="card__cover__slide-item"><img src="assets/images/posts/3.png" alt="Looking for some feedback for this rejected track"/></div>
                        <div class="card__cover__slide-item"><img src="assets/images/posts/4.png" alt="Looking for some feedback for this rejected track"/></div>
                      </div>
                      <div class="card__content">
                        <h5 class="card__content-category">Technology</h5><a class="card__content-title" href="../post_standard.ftl">Looking for some feedback for this rejected track</a>
                        <div class="card__content-info">
                    ...
                    <div class="post-card -center"><a class="card__cover" href="../post_standard.ftl"><img src="assets/images/posts/6.png" alt="where I can found the sound in this video template?"/></a>
                      <div class="card__content">
                    ...
                    <div class="post-card -center"><a class="card__cover" href="../post_standard.ftl"><img src="assets/images/posts/7.png" alt="I want to create a logo with illustrator hacker"/></a>
                      <div class="card__content">
                        <h5 class="card__content-category">Graphic</h5><a class="card__content-title" href="../post_standard.ftl">I want to create a logo with illustrator hacker</a>
                        <div class="card__content-info">
                          <div class="info__time"><i class="far fa-clock"></i>
                    ...
                    <div class="post-card -center"><a class="card__cover" href="../post_standard.ftl"><img src="assets/images/posts/8.png" alt="where I can found the sound in this video template?"/></a>
                      <div class="card__content">
                        <h5 class="card__content-category">Typography</h5><a class="card__content-title" href="../post_standard.ftl">where I can found the sound in this video template?</a>
                        <div class="card__content-info">
                          <div class="info__time"><i class="far fa-clock"></i>
                    ...
                    <div class="post-card -center"><a class="card__cover" href="../post_standard.ftl"><img src="assets/images/posts/9.png" alt="I want to create a logo with illustrator hacker"/></a>
                      <div class="card__content">
                        <h5 class="card__content-category">Graphic</h5><a class="card__content-title" href="../post_standard.ftl">I want to create a logo with illustrator hacker</a>
                        <div class="card__content-info">
                          <div class="info__time"><i class="far fa-clock"></i>
