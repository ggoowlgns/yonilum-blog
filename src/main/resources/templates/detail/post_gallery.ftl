...
<html lang="en">
  ...
  <body>
    ...
    <header class="theme-default">
      ...
      <div class="container">
        <div class="header-wrapper"><a class="header__logo" href="../deprecated/index.ftl"><img src="./assets/images/logo.png" alt="Logo"/></a>
          <nav>
            <ul>
              <li class="nav-item"><a href="../deprecated/index.ftl">Home</a>
                <ul class="dropdown-menu">
                  <li><a href="../deprecated/index.ftl">HOMEPAGE1</a></li>
                  <li><a href="../deprecated/homepage2.ftl">HOMEPAGE2</a></li>
                  <li><a href="../deprecated/homepage3.ftl">HOMEPAGE3</a></li>
                  <li><a href="../homepage4.ftl">HOMEPAGE4</a></li>
                  <li><a href="../deprecated/homepage5.ftl">HOMEPAGE5</a></li>
                  <li><a href="../deprecated/homepage6.ftl">HOMEPAGE6</a></li>
                  <li><a href="../deprecated/homepage7.ftl">HOMEPAGE7</a></li>
                  <li><a href="../deprecated/homepage8.ftl">HOMEPAGE8</a></li>
                  <li><a href="../deprecated/homepage9.ftl">HOMEPAGE9</a></li>
                </ul>
              </li>
