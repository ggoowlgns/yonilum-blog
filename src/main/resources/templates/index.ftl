    ...
    <div id="content">
      <div class="container">
        <div class="blog-imageless">
          <div class="row">
            <div class="col-12">
                  <div class="post-card -center -banner -inner-text"><a class="card__cover" href="deprecated/post_standard.ftl"><img src="assets/images/posts/banner-post.png" alt="Looking for some feedback for this rejected track"/></a>
            ...
            <div class="col-12 col-lg-6">
                  ...
                  <div class="post-card -image-less">
                    <div class="category-icon"><img src="assets/images/icons/category-icon-graphic.png" alt="Graphic"/></div>
                    <div class="card__content">
                  ...
                  <div class="post-card -image-less">
                    <div class="category-icon"><img src="assets/images/icons/category-icon-desgin.png" alt="Design"/></div>
                    <div class="card__content">
                      <h5 class="card__content-category">Design</h5><a class="card__content-title" href="deprecated/post_standard.ftl">where I can found the sound in this video template?</a>
                      <div class="card__content-info">
                        <div class="info__time info__author"><i class="far fa-user"></i>
                          <p>Jessica Stephens</p>
                        </div>
            ...
            <div class="col-12 col-lg-6">
                  <div class="post-card -image-less">
                    <div class="category-icon"><img src="assets/images/icons/category-icon-typography.png" alt="Typography"/></div>
                    <div class="card__content">
                      <h5 class="card__content-category">Typography</h5><a class="card__content-title" href="deprecated/post_standard.ftl">where I can found the sound in this video template?</a>
                      <div class="card__content-info">
                        <div class="info__time info__author"><i class="far fa-user"></i>
                          <p>Jessica Stephens</p>
                        </div>
              ...
              <div class="footer-col -util">
                <div class="row">
                  <div class="col-12 col-md-6 col-lg-12">
                    ...
                    <div class="tags-group"><a class="tag-btn" href="deprecated/blog_category_grid.ftl">Gutenews</a><a class="tag-btn" href="deprecated/blog_category_grid.ftl">Lifestyle</a><a class="tag-btn" href="deprecated/blog_category_grid.ftl">Fashion</a><a class="tag-btn" href="deprecated/blog_category_grid.ftl">Technology</a><a class="tag-btn" href="deprecated/blog_category_grid.ftl">Food</a><a class="tag-btn" href="deprecated/blog_category_grid.ftl">Travel</a>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-lg-12">
                    <div class="center-line-title"> 
