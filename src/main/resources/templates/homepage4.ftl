    ...
    <div id="content">
      <div class="container">
        <div class="blog-imageless">
          <div class="row">
            <div class="col-12">
                  <div class="post-card -center -banner -inner-text"><a class="card__cover" href="post_standard.ftl"><img src="assets/images/posts/banner-post.png" alt="Looking for some feedback for this rejected track"/></a>
