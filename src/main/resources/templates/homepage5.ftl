      ...
      <div class="container">
        <div class="blog-imageless-mansonry">
          ...
          <div class="blog-imageless-mansonry__content">
                <div class="post-card -center -middle -inner-text -small"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/1.png" alt="How to name, save and export a finish template"/></a>
                ...
                <div class="post-card -center -middle -inner-text -big"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/big-1.png" alt="Looking for some feedback for this rejected track"/></a>
                  <div class="card__content">
                ...
                <div class="post-card -center -middle -inner-text -long"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/long-1.png" alt="How to name, save and export a finish template"/></a>
                  <div class="card__content">
                    <h5 class="card__content-category">Typography</h5><a class="card__content-title" href="post_standard.html">How to name, save and export a finish template</a>
                    <div class="card__content-info">
                      <div class="info__time"><i class="far fa-clock"></i>
                ...
                <div class="post-card -center -middle -inner-text -small"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/3.png" alt="Looking for some feedback for this rejected track"/></a>
                  <div class="card__content">
                    <h5 class="card__content-category">Technology</h5><a class="card__content-title" href="post_standard.html">Looking for some feedback for this rejected track</a>
                    <div class="card__content-info">
                      <div class="info__time"><i class="far fa-clock"></i>
                ...
                <div class="post-card -center -middle -inner-text -small"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/5.png" alt="where I can found the sound in this video template?"/></a>
                  <div class="card__content">
                ...
                <div class="post-card -center -middle -inner-text -big"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/big-2.png" alt="How to name, save and export a finish template"/></a>
                  <div class="card__content">
                    <h5 class="card__content-category">Typography</h5><a class="card__content-title" href="post_standard.html">How to name, save and export a finish template</a>
                    <div class="card__content-info">
                      <div class="info__time"><i class="far fa-clock"></i>
                ...
                <div class="post-card -center -middle -inner-text -long"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/long-2.png" alt="I want to create a logo with illustrator hacker"/></a>
                  <div class="card__content">
                ...
                <div class="post-card -center -middle -inner-text -small"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/2.png" alt="How to name, save and export a finish template"/></a>
                  <div class="card__content">
                    <h5 class="card__content-category">Typography</h5><a class="card__content-title" href="post_standard.html">How to name, save and export a finish template</a>
                    <div class="card__content-info">
                      <div class="info__time"><i class="far fa-clock"></i>
                ...
                <div class="post-card -center -middle -inner-text -long"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/long-3.png" alt="where I can found the sound in this video template?"/></a>
                  <div class="card__content">
                    <h5 class="card__content-category">Design</h5><a class="card__content-title" href="post_standard.html">where I can found the sound in this video template?</a>
                    <div class="card__content-info">
                      <div class="info__time"><i class="far fa-clock"></i>
                ...
                <div class="post-card -center -middle -inner-text -small"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/4.png" alt="I want to create a logo with illustrator hacker"/></a>
                  <div class="card__content">
                    <h5 class="card__content-category">Graphic</h5><a class="card__content-title" href="post_standard.html">I want to create a logo with illustrator hacker</a>
                    <div class="card__content-info">
                      <div class="info__time"><i class="far fa-clock"></i>
                ...
                <div class="post-card -center -middle -inner-text -big"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/big-3.png" alt="I want to create a logo with illustrator hacker"/></a>
                  <div class="card__content">
                    <h5 class="card__content-category">Graphic</h5><a class="card__content-title" href="post_standard.html">I want to create a logo with illustrator hacker</a>
                    <div class="card__content-info">
                      <div class="info__time"><i class="far fa-clock"></i>
                ...
                <div class="post-card -center -middle -inner-text -small"><a class="card__cover" href="post_standard.html"><img src="assets/images/posts/masonry_row/6.png" alt="How to name, save and export a finish template"/></a>
                  <div class="card__content">
                    <h5 class="card__content-category">Typography</h5><a class="card__content-title" href="post_standard.html">How to name, save and export a finish template</a>
                    <div class="card__content-info">
                      <div class="info__time"><i class="far fa-clock"></i>
